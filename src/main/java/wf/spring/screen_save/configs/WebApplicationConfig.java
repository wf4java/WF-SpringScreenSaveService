...
import wf.spring.screen_save.properties.ConfigProperties;
...
@Configuration
@EnableConfigurationProperties({JwtProperties.class, ConfigProperties.class, ImageStorageProperties.class, VerificationProperties.class})
@EnableScheduling
